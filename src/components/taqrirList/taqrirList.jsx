...
<h1>درباره ما</h1>
<p style={{fontFamily:'vazirmatn'}}>به ویب سایت اعجاز قرآن خوش آمديد، اعجاز قرآن نایاب ترین مباحث قرآنی منجمله اعجاز آن را که تا حال از آن سخن بمیان نیامده است،  در دسترس جهانیان بخصوص امت مسلمه قرار می‌دهد.
     ...
     نهاد اعجاز قرآن چی تفاوتی با سایت های دیگر دارد
        <ul style={{marginRight: "20px"}}>
          <li>      بیان اعجاز علوم ظاهر، باطنی، نقوش، عددی و لدنی قرآن کریم 
          </li>
          <li>
