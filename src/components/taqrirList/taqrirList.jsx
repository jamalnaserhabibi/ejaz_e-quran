...
<h1>درباره ما</h1>
     ...
     "اعجاز قرآن" وب سایتی که توسط مدرسه خانقاء سلسله عالیه چشتیه محمدیﷺ  ناحیه هفتم شهر کابل افغانستان ایجاد گردیده است، می‌خواهد توازن معنویات و مادیات را از طریق بیان ارزش های معنوی بالخصوص اعجاز قرآن ، جوابگو بودن قرآن برای هر عصر، حل معما های لاینحل، برقرار نماید. 
     ...
     این نهاد برای استدلال خویش در قدم اول قرآن عظيم الشأن و در قدم بعدی به حديث صحيح استدلال می‌کند.
