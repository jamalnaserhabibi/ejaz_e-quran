...
<h1>درباره ما</h1>
     <p>به ویب سایت اعجاز قرآن خوش آمديد، اعجاز قرآن نایاب ترین مباحث قرآنی منجمله اعجاز آن را که تا حال از آن سخن بمیان نیامده است،  در دسترین جهانیان بخصوص امت مسلمه قرار می‌دهد.
